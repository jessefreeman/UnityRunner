...
namespace PixelVisionSDK.Engine.Utils
{
    ...
    public class ImportUtil
    {
        ...
        /// <returns>
        /// </returns>
        public static Color[] IndexColorsFromTexture(Texture2D src, bool unique = true, bool ignoreTransparent = true)
        {
            ...
            bool saveAsDeafult = true)
        {
            ...
            var indexedColors = IndexColorsFromTexture(src, true, false);
            ...
            bool unique = true)
        {
            ...
            for (var i = 0; i < totalSprites; i++)
            {
                ...
                {
                    if (!SpriteChip.IsEmpty(spriteData))
                    {
                        if (unique)
                        {
        ...
        /// <returns>
        /// </returns>
        public static Color[] CutOutSpriteFromTexture2D(int index, Texture2D texture2d, int spriteWidth,
            int spriteHeight)
        {
            int x, y;
        ...
        public static void ConvertColorsToIndexes(ref int[] indexes, Color[] pixels, Color[] refColors, int totalColors)
        {
        ...
        public static void ImportFlagsFromTexture(Texture2D src, IEngineChips chips)
        {
            var spriteChip = chips.spriteChip;
        ...
        public static void ImportColorMapFromTexture(Texture2D src, IEngineChips engine)
        {
            ...
            // Load Texture
            var mapColors = IndexColorsFromTexture(src, true, false);
        ...
        public static void ImportFontFromTexture(Texture2D src, IEngineChips chips, string name = "Default",
        ...
        public static void ApplyColor(ref Color c1, ColorData c2)
        {
            c1.r = c2.r;
            c1.g = c2.g;
            c1.b = c2.b;
        ...
        public static void ApplyColors(ref Color[] c1, ColorData[] c2)
        {
