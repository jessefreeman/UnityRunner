...
public class DrawSpriteDemoGameChip : GameChip
{
...
// use this method to configure background color, ScreenBufferChip and draw a text box.
    ...
    {
        ghostSprites = new GhostSprites(ghost.spriteIDs, new[] {face1.spriteIDs[0], face2.spriteIDs[0]}, ghost.width);
...
// all of our draw calls should go. We'll be using this to r}er sprites to the display.
    public override void Draw()
    {
        ...
        newX = newX + 24;
        DrawSprites(ghostSprites.body, newX, newY, ghostSprites.width, true); // TODO enabeling this makes all the ghost sprites render strangly
