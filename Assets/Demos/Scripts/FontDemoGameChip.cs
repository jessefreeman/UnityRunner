...
namespace PixelVisionRunner.FontDemo
{
    public class FontDemoChip : GameChip
    {
        private readonly int Black = 32;

        private readonly int Blue = 52;
...
// values of each character starting with an empty space at 32.
        ...
        private readonly string longText =
            "This is a test to see how long we can make text in a text box? Blahblahblahblahblahablahblahblah";

        private readonly int Orange = 53;

// We'll use this field to keep track of the current time that has elapsed since the game has started.
        private float time;

        private readonly int White = 51;

        private readonly int wrapWidth = 12;
...
// is where all of our draw calls should go. We'll be using this to r}er font characters to the display.
        ...
        public int DrawTextBox(string text, int x, int y, int width, string font, int colorOffset = 0, int spacing = 0,
