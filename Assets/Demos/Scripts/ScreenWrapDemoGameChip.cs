...
//        base.Update(deltaTime);
        ...
        if ((gameChip.Button(Buttons.Up) || gameChip.Button(Buttons.A) || gameChip.Button(Buttons.B)) && p1.isgrounded) p1.dy = -p1.jumpvel;
...
public class ScreenWrapDemoGameChip : GameChip
{
