...
public class ControllerDemoGameChip : GameChip
{
	...
	private bool[] player1States = new bool[totalButtons];
	private bool[] player2States = new bool[totalButtons];
	
	// We'll use these values to help lay out the button state text.
	private Vector pos = new Vector(1, 3);
