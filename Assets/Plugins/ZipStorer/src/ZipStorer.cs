...
//            }
        ...
        public List<ZipFileEntry> ReadCentralDir()
        {
            ...
            for (int pointer = 0; pointer < this.CentralDirImage.Length; )
            {
                ...
                Encoding encoder = Encoding.UTF8;//encodeUTF8 ? Encoding.UTF8 : DefaultEncoding;
        ...
        */
        ...
        {
            long pos = this.ZipFileStream.Position;
            Encoding encoder = Encoding.UTF8;//_zfe.EncodeUTF8 ? Encoding.UTF8 : DefaultEncoding;
        ...
        */
        ...
        {
            Encoding encoder = Encoding.UTF8;//this.EncodeUTF8 ? Encoding.UTF8 : DefaultEncoding;
